...
from homeassistant.components.climate.const import (
    ...
    SUPPORT_TARGET_TEMPERATURE_RANGE, SUPPORT_FAN_MODE, SUPPORT_SWING_MODE,ATTR_HVAC_MODE, HVAC_MODES, HVACMode
)
...
class TuyaClimate(ClimateEntity):
    ...
    mode_mapping = {HVACMode.DRY: 4, HVACMode.FAN_ONLY: 3, HVACMode.AUTO: 2, HVACMode.COOL: 0, HVACMode.OFF: 0}
                        ...
                        if ac_status_response.get("success", False):
                            ...
                            if not result:
                                ...
                                if power_open:
                                    ...
                                    # Update HVAC mode
                                    mode = int(ac_data.get("mode", 0))  # Default to mode 0 if not provided
                                    self._hvac_mode = self.mode_mapping.get(mode, HVACMode.COOL)  # Assuming mode 0 corresponds to COOL
